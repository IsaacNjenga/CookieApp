...
const submission_url = process.env.DEMO_PESAPAL_URL;
const transaction_url = process.env.DEMO_PESAPAL_TRANSACTION_URL;
const notification_id = process.env.DEMO_PESAPAL_IPN_ID;
const callback_url = process.env.DEMO_CALLBACK_URL;
const cancellation_url = process.env.DEMO_CANCELLATION_URL;
...
const submitOrder = async (req, res) => {
  ...
  try {
    ...
    const orderDetails = {
      ...
      currency: "KES",
      description: "Uncle Martin Cookies",
